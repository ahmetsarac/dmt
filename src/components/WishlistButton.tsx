        ...
        <a
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLElement).style.background =
              "linear-gradient(to bottom right, #fde047, #facc15, #ea580c)";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLElement).style.background =
              "linear-gradient(to bottom right, #fde047, #facc15, #ea580c)";
          ...
          <span className="relative z-10 flex items-center justify-center gap-2">
            ...
            >
              <g transform="translate(0.000000,128.000000) scale(0.100000,-0.100000)">
                <path
                  d="M507 1255 c-181 -36 -349 -170 -433 -342 -31 -65 -73 -218 -62 -228
                ...
                />
                <path
                  d="M780 938 c-66 -34 -93 -79 -88 -148 5 -64 26 -99 79 -129 104 -59
                ...
                />
                <path
                  d="M410 526 c0 -4 20 -15 43 -25 88 -38 114 -116 58 -172 -34 -34 -80
